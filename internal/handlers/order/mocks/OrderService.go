...
func (_m *OrderService) AddOrderItem(ctx context.Context, orderItem models.OrderItem) error {
...
func (_m *OrderService) CreateOrder(ctx context.Context, _a1 models.Order) (int, error) {
...
func (_m *OrderService) GetOrderItemsByOrderID(ctx context.Context, orderID int) ([]models.OrderItem, error) {
...
func (_m *OrderService) GetOrdersByUserEmail(ctx context.Context, email string) ([]models.Order, error) {
...
func (_m *OrderService) GetUserOrderHistory(ctx context.Context, email string) ([]models.OrderDetail, error) {
	ret := _m.Called(ctx, email)
...
func (_m *OrderService) PlaceOrder(ctx context.Context, userEmail string, items []models.OrderItem) (int, error) {
